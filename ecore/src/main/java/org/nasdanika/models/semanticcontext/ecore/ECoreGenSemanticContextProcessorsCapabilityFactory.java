...
public class ECoreGenSemanticContextProcessorsCapabilityFactory implements CapabilityFactory<TargetRequirement, Object> {
		...
		return CompletableFuture.completedStage(
				Collections.singleton(
						CapabilityProvider.of(
								new EcoreGenSemanticContextProcessorsFactory(requirement.requirement().context()))));
	}
