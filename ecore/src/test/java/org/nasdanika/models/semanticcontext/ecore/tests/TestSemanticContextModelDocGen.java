package org.nasdanika.models.semanticcontext.ecore.tests;
...
import org.nasdanika.models.semanticcontext.ecore.EcoreGenSemanticContextProcessorsFactory;
 ...
 *
 */
public class TestSemanticContextModelDocGen {
	...
	public void testGenerateSemanticContextModelDoc() throws IOException, DiagnosticException {
		...
		EcoreGenSemanticContextProcessorsFactory ecoreGenProcessorFactory = new EcoreGenSemanticContextProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "semantic-context.xmi");
		...
		EcoreHtmlAppGenerator eCoreHtmlAppGenerator = new EcoreHtmlAppGenerator(
				SemanticContextPackage.eINSTANCE, 
				packageURIMap, 
		...
		String siteMapDomain = "https://semantic-context.models.nasdanika.org";		
